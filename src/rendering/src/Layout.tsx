  ...
  return (
    <>
      <Head>
        ...
        <link rel="preload" as="style" href={`https://fonts.googleapis.com/css?family=Open+Sans:400,400i,600,600i,700,700i&display=swap`} />
        <link rel="stylesheet" href={`https://fonts.googleapis.com/css?family=Open+Sans:400,400i,600,600i,700,700i&display=swap`} media="print" />
